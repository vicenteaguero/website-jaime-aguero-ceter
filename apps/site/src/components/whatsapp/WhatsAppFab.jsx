...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-4 sm:bottom-8 sm:right-8 z-40 inline-flex items-center gap-3 bg-whatsapp hover:bg-whatsapp-dark text-white rounded-full shadow-lg shadow-black/20 motion-safe:transition-all motion-safe:duration-300 ease-soft motion-safe:hover:scale-105"
    ...
    >
      ...
      <span
        className={[
          "pr-5 pl-1 hidden sm:inline-block whitespace-nowrap font-semibold text-sm",
          "max-w-0 overflow-hidden transition-[max-width,opacity,padding] duration-300 ease-soft opacity-0",
          hovered ? "max-w-xs opacity-100 pl-1 pr-5" : ""
        ].join(" ")}
        aria-hidden="true"
      >
